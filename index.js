...
const users =[
    { name :"rishik1",password :"password1",profession : "student1",id :1 },
    { name :"rishik2",password :"password2",profession : "student2",id :2 },
    { name :"rishik3",password :"password3",profession : "student3",id :3 },
    { name :"rishik4",password :"password4",profession : "student4",id :4 }

];

app.use('/',function(req,res,next){
    fs.writeFileSync("sync.txt",req.url +"  "+req.method,"\n");
    next();
});
